...
namespace SpaceWhale.HierarchyInspector.Editor
{
    internal static partial class HierarchyOverlay
    {
            ...
            bool isSelected)
        {
            ...
            // Full row width. The gear, active toggle, and foldout are drawn afterwards on top,
            // so spanning the entire row doesn't hide them.
            float endX = GetEffectiveRowEndX();
            float startX = 0f;
            float barWidth = Mathf.Max(0f, endX - startX);
