...
namespace SpaceWhale.HierarchyInspector.Editor
{
    ...
    {
        private const string TabPrefKey = "SpaceWhale.HierarchyInspector.Theme.SelectedTab";
        private const string FoldoutPrefPrefix = "SpaceWhale.HierarchyInspector.Theme.Foldout.";
