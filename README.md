...
_Coming soon_ — drag the `.unitypackage` into your Unity project, or import via the Package Manager.

## Documentation

Full documentation is published via GitBook. The source lives in [`docs/`](docs/).
